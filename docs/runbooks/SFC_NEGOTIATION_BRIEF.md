...
4. Stock lookup
   ...
   - Confirm `getStock` or stock-by-SKU access for ODUN SKUs.
...
5. Asia DDP and rates
   ...
   - Confirm required rate parameters: country, warehouse, weight, dimensions, method code, and price type.
